    ...
    const pokemons = [
        {
            ...
            height: 0.4,
            weight: 6.0,
            description: "Um Pokémon do tipo Elétrico conhecido por suas bochechas vermelhas que armazenam eletricidade.",
            baseHp: 35,
            baseAttack: 55,
            baseDefense: 40,
            baseSpeed: 90,
        ...
        },
        {
            ...
            height: 1.7,
            weight: 90.5,
            description: "Um poderoso Pokémon dragão que cospe fogo intenso de sua boca.",
            baseHp: 78,
            baseAttack: 84,
            baseDefense: 78,
            baseSpeed: 100,
        ...
        },
        {
            ...
            height: 1.6,
            weight: 85.5,
            description: "Um Pokémon tartaruga que atira poderosos jatos de água de seus canhões.",
            baseHp: 79,
            baseAttack: 83,
            baseDefense: 100,
            baseSpeed: 78,
        ...
        },
        {
            ...
            height: 2.0,
            weight: 100.0,
            description: "Um grande Pokémon planta com uma flor nas costas que exala um aroma calmante.",
            baseHp: 80,
            baseAttack: 82,
            baseDefense: 83,
            baseSpeed: 80,
        ...
        },
        {
            ...
            height: 1.5,
            weight: 48.0,
            description: "Um Pokémon psíquico extremamente inteligente com poderes telepáticos.",
            baseHp: 55,
            baseAttack: 50,
            baseDefense: 45,
            baseSpeed: 120,
