...
const swaggerDefinition = {
    ...
    info: {
        title: "Pokémon API",
        version: "1.0.0",
        description: "API RESTful para gerenciamento de Pokémons com validação robusta e operações CRUD completas",
        contact: {
    ...
    components: {
        schemas: {
            Pokemon: {
                ...
                properties: {
                    ...
                    description: {
                        ...
                        example: "Um Pokémon do tipo Elétrico conhecido por suas bochechas vermelhas.",
                        maxLength: 1000,
                    },
                    imageUrl: {
                        type: "string",
            ...
            UpdatePokemonRequest: {
                type: "object",
                description: "Dados para atualização do Pokémon (todos os campos são opcionais)",
                properties: {
                    name: {
                        type: "string",
                        description: "Nome do Pokémon",
